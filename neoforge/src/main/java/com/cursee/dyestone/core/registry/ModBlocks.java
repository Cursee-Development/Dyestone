...
public class ModBlocks {
    ...
    public static final Block DYED_WHITE_REDSTONE_WIRE = new ModRedStoneWireBlock(BlockBehaviour.Properties.of().noCollission().instabreak().pushReaction(PushReaction.DESTROY).isRedstoneConductor((blockState, blockGetter, blockPos) -> true));
    public static final Block DYED_ORANGE_REDSTONE_WIRE = new ModRedStoneWireBlock(BlockBehaviour.Properties.of().noCollission().instabreak().pushReaction(PushReaction.DESTROY));
    ...
    public static final Block DYED_LIGHT_BLUE_REDSTONE_WIRE = new ModRedStoneWireBlock(BlockBehaviour.Properties.of().noCollission().instabreak().pushReaction(PushReaction.DESTROY));
    public static final Block DYED_YELLOW_REDSTONE_WIRE = new ModRedStoneWireBlock(BlockBehaviour.Properties.of().noCollission().instabreak().pushReaction(PushReaction.DESTROY));
    public static final Block DYED_LIME_REDSTONE_WIRE = new ModRedStoneWireBlock(BlockBehaviour.Properties.of().noCollission().instabreak().pushReaction(PushReaction.DESTROY));
    public static final Block DYED_PINK_REDSTONE_WIRE = new ModRedStoneWireBlock(BlockBehaviour.Properties.of().noCollission().instabreak().pushReaction(PushReaction.DESTROY));
    public static final Block DYED_GRAY_REDSTONE_WIRE = new ModRedStoneWireBlock(BlockBehaviour.Properties.of().noCollission().instabreak().pushReaction(PushReaction.DESTROY));
