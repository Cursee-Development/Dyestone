...
public class ModItems {
    ...
    public static final Item DYED_ORANGE_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_MAGENTA_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_LIGHT_BLUE_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_YELLOW_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_LIME_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_PINK_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_GRAY_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_LIGHT_GRAY_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_CYAN_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_PURPLE_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_BLUE_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_BROWN_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_GREEN_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_RED_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
    public static final Item DYED_BLACK_REDSTONE_WIRE = new BlockItem(ModBlocks.DYED_WHITE_REDSTONE_WIRE, new Item.Properties());
